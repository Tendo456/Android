...
public class QuestResponse implements Serializable {
    ...
    private String idQuestGuyana;
    private String date_g;
    private String time_g;
    ...
    public String getIdQuestGuyana() {
        return idQuestGuyana;
    }

    public void setIdQuestGuyana(String idQuestGuyana) {
        this.idQuestGuyana = idQuestGuyana;
    }
    ...
    public void setDate_g(String date_g) {
        this.date_g = date_g;
    }

    public String getTime_g() {
        return time_g;
    }

    public void setTime_g(String time_g) {
        this.time_g = time_g;
    }
