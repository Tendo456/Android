...
/**
 * The interface for the Role Definition Reference Request Builder.
 */
public interface IRoleDefinitionReferenceRequestBuilder extends IRequestBuilder {
     ...
     * @return the IRoleDefinitionReferenceRequest instance
     */
    IRoleDefinitionReferenceRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
