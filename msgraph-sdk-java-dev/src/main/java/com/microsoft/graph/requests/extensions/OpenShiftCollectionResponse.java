 ...
 */
public class OpenShiftCollectionResponse implements IJsonBackedObject {

    /**
     * The list of OpenShift within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<OpenShift> value;
