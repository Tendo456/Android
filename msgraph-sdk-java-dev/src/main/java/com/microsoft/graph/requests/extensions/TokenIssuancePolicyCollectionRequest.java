 ...
 */
public class TokenIssuancePolicyCollectionRequest extends BaseCollectionRequest<TokenIssuancePolicyCollectionResponse, ITokenIssuancePolicyCollectionPage> implements ITokenIssuancePolicyCollectionRequest {
     ...
     */
    public ITokenIssuancePolicyCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public ITokenIssuancePolicyCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public ITokenIssuancePolicyCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public ITokenIssuancePolicyCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public ITokenIssuancePolicyCollectionRequest top(final int value) {
     ...
     * @return the updated request
     */
    public ITokenIssuancePolicyCollectionRequest skip(final int value) {
     ...
     * @return the updated request
     */
    public ITokenIssuancePolicyCollectionRequest skipToken(final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (ITokenIssuancePolicyCollectionRequest)this;
    }
    public ITokenIssuancePolicyCollectionPage buildFromResponse(final TokenIssuancePolicyCollectionResponse response) {
        final ITokenIssuancePolicyCollectionRequestBuilder builder;
