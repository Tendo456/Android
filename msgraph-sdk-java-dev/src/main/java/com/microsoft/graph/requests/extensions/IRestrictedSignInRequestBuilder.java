...
/**
 * The interface for the Restricted Sign In Request Builder.
 */
public interface IRestrictedSignInRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IRestrictedSignInRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
