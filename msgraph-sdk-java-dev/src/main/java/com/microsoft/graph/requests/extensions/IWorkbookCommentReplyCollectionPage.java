...
/**
 * The interface for the Workbook Comment Reply Collection Page.
 */
public interface IWorkbookCommentReplyCollectionPage extends IBaseCollectionPage<WorkbookCommentReply, IWorkbookCommentReplyCollectionRequestBuilder> {
}
