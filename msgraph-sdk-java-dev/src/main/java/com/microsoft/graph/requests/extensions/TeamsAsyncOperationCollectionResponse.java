 ...
 */
public class TeamsAsyncOperationCollectionResponse implements IJsonBackedObject {

    /**
     * The list of TeamsAsyncOperation within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<TeamsAsyncOperation> value;
