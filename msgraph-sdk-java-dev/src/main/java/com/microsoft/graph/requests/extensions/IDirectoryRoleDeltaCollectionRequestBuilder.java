...
public interface IDirectoryRoleDeltaCollectionRequestBuilder extends IRequestBuilder {
     ...
     */
    IDirectoryRoleDeltaCollectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IUserRequest instance
     */
    IDirectoryRoleDeltaCollectionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
