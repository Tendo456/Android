...
/**
 * The interface for the Calendar Permission Request Builder.
 */
public interface ICalendarPermissionRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    ICalendarPermissionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
