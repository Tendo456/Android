 ...
 */
public class WorkbookFunctionsPriceRequest extends BaseRequest implements IWorkbookFunctionsPriceRequest {
     ...
     */
    public WorkbookFunctionsPriceRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
