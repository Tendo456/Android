...
public interface IWorkbookFunctionsPiRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsPiRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookFunctionsPiRequest instance
     */
    IWorkbookFunctionsPiRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
