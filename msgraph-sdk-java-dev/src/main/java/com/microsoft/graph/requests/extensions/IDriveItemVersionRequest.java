...
public interface IDriveItemVersionRequest extends IHttpRequest {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    DriveItemVersion put(final DriveItemVersion newDriveItemVersion) throws ClientException;
     ...
     */
    IDriveItemVersionRequest select(final String value);
     ...
     * @return the updated request
     */
    IDriveItemVersionRequest expand(final String value);
