...
/**
 * The interface for the Service Principal Collection Request.
 */
public interface IServicePrincipalCollectionRequest extends IHttpRequest {
     ...
     */
    IServicePrincipalCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IServicePrincipalCollectionRequest skip(final int value);
