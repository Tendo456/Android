...
/**
 * The interface for the Presence Collection Page.
 */
public interface IPresenceCollectionPage extends IBaseCollectionPage<Presence, IPresenceCollectionRequestBuilder> {
}
