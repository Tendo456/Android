...
/**
 * The interface for the Directory Audit Request Builder.
 */
public interface IDirectoryAuditRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IDirectoryAuditRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
