 ...
 */
public class IosCustomConfigurationRequestBuilder extends BaseRequestBuilder implements IIosCustomConfigurationRequestBuilder {
     ...
     * @return the IIosCustomConfigurationRequest instance
     */
    public IIosCustomConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
