 ...
 */
public class WorkbookFunctionsRandRequest extends BaseRequest implements IWorkbookFunctionsRandRequest {
     ...
     */
    public WorkbookFunctionsRandRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
