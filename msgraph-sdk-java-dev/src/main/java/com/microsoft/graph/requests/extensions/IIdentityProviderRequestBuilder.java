...
/**
 * The interface for the Identity Provider Request Builder.
 */
public interface IIdentityProviderRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IIdentityProviderRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
