...
/**
 * The interface for the Mobile Threat Defense Connector Request.
 */
public interface IMobileThreatDefenseConnectorRequest extends IHttpRequest {
     ...
     */
    IMobileThreatDefenseConnectorRequest select(final String value);
     ...
     * @return the updated request
     */
    IMobileThreatDefenseConnectorRequest expand(final String value);
