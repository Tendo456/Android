 ...
 */
public class WorkbookFunctionsEcma_CeilingRequest extends BaseRequest implements IWorkbookFunctionsEcma_CeilingRequest {
     ...
     */
    public WorkbookFunctionsEcma_CeilingRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
