...
/**
 * The interface for the Schedule Change Request Approve Request Builder.
 */
public interface IScheduleChangeRequestApproveRequestBuilder extends IRequestBuilder {
     ...
     */
    IScheduleChangeRequestApproveRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IScheduleChangeRequestApproveRequest instance
     */
    IScheduleChangeRequestApproveRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
