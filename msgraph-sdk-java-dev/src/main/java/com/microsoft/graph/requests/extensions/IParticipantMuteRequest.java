...
/**
 * The interface for the Participant Mute Request.
 */
public interface IParticipantMuteRequest extends IHttpRequest {
     ...
     */
    IParticipantMuteRequest select(final String value) ;
     ...
     * @return the updated request
     */
    IParticipantMuteRequest top(final int value);
     ...
     * @return the updated request
     */
    IParticipantMuteRequest expand(final String value);
