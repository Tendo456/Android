...
/**
 * The interface for the Windows10General Configuration Request Builder.
 */
public interface IWindows10GeneralConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindows10GeneralConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
