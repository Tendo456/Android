 ...
 */
public class TrendingCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Trending within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Trending> value;
