...
public class UserScopeTeamsAppInstallationCollectionRequestBuilder extends BaseRequestBuilder implements IUserScopeTeamsAppInstallationCollectionRequestBuilder {
     ...
     */
    public IUserScopeTeamsAppInstallationCollectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IUserRequest instance
     */
    public IUserScopeTeamsAppInstallationCollectionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
