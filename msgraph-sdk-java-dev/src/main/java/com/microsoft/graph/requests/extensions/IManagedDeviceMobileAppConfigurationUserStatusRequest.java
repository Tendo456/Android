...
/**
 * The interface for the Managed Device Mobile App Configuration User Status Request.
 */
public interface IManagedDeviceMobileAppConfigurationUserStatusRequest extends IHttpRequest {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    ManagedDeviceMobileAppConfigurationUserStatus put(final ManagedDeviceMobileAppConfigurationUserStatus newManagedDeviceMobileAppConfigurationUserStatus) throws ClientException;
     ...
     */
    IManagedDeviceMobileAppConfigurationUserStatusRequest select(final String value);
     ...
     * @return the updated request
     */
    IManagedDeviceMobileAppConfigurationUserStatusRequest expand(final String value);
