...
/**
 * The interface for the Device And App Management Role Assignment Request Builder.
 */
public interface IDeviceAndAppManagementRoleAssignmentRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IDeviceAndAppManagementRoleAssignmentRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
