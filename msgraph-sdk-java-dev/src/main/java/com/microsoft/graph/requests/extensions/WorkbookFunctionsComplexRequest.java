 ...
 */
public class WorkbookFunctionsComplexRequest extends BaseRequest implements IWorkbookFunctionsComplexRequest {
     ...
     */
    public WorkbookFunctionsComplexRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
