...
public interface IThumbnailContentStreamRequestBuilder extends IRequestBuilder {
     ...
     */
    IThumbnailContentStreamRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IThumbnailContentStreamRequest instance
     */
    IThumbnailContentStreamRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
