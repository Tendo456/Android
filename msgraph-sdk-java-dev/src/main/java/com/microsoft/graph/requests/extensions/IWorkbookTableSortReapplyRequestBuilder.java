...
public interface IWorkbookTableSortReapplyRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookTableSortReapplyRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IWorkbookTableSortReapplyRequest instance
     */
    IWorkbookTableSortReapplyRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
