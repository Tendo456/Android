...
public class SectionGroupCollectionRequest extends BaseCollectionRequest<SectionGroupCollectionResponse, ISectionGroupCollectionPage> implements ISectionGroupCollectionRequest {
    ...
    public ISectionGroupCollectionPage get() throws ClientException {
        final SectionGroupCollectionResponse response = send();
     ...
     * @return the updated request
     */
    public ISectionGroupCollectionRequest skip(final int value) {
     ...
     * @return the updated request
     */
    public ISectionGroupCollectionRequest skipToken(final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (ISectionGroupCollectionRequest)this;
    }
    public ISectionGroupCollectionPage buildFromResponse(final SectionGroupCollectionResponse response) {
