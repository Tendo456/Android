 ...
 */
public class ReportRootGetOffice365ActiveUserDetailRequest extends BaseRequest implements IReportRootGetOffice365ActiveUserDetailRequest {
     ...
     */
    public ReportRootGetOffice365ActiveUserDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the updated request
     */
    public IReportRootGetOffice365ActiveUserDetailRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IReportRootGetOffice365ActiveUserDetailRequest orderBy(final String value) {
