...
public class WindowsDefenderAdvancedThreatProtectionConfigurationRequestBuilder extends BaseRequestBuilder implements IWindowsDefenderAdvancedThreatProtectionConfigurationRequestBuilder {
     ...
     */
    public IWindowsDefenderAdvancedThreatProtectionConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
    ...
    public IWindowsDefenderAdvancedThreatProtectionConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.WindowsDefenderAdvancedThreatProtectionConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
