...
/**
 * The class for the Presence Collection Response.
 */
public class PresenceCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Presence within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Presence> value;
