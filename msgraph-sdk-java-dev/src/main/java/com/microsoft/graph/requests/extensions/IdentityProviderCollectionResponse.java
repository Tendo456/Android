 ...
 */
public class IdentityProviderCollectionResponse implements IJsonBackedObject {

    /**
     * The list of IdentityProvider within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<IdentityProvider> value;
