...
/**
 * The interface for the Group Assign License Request Builder.
 */
public interface IGroupAssignLicenseRequestBuilder extends IRequestBuilder {
     ...
     */
    IGroupAssignLicenseRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
