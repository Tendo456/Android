 ...
 */
public class ReportRootGetOffice365ActivationCountsRequest extends BaseRequest implements IReportRootGetOffice365ActivationCountsRequest {
     ...
     */
    public ReportRootGetOffice365ActivationCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the updated request
     */
    public IReportRootGetOffice365ActivationCountsRequest orderBy(final String value) {
