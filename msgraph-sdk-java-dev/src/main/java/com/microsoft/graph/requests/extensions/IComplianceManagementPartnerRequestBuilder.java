...
/**
 * The interface for the Compliance Management Partner Request Builder.
 */
public interface IComplianceManagementPartnerRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IComplianceManagementPartnerRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
