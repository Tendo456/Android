...
public class WorkbookNamedItemAddFormulaLocalRequest extends BaseRequest implements IWorkbookNamedItemAddFormulaLocalRequest {
     ...
     */
    public WorkbookNamedItemAddFormulaLocalRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
