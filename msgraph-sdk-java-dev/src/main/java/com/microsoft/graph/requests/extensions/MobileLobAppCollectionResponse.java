 ...
 */
public class MobileLobAppCollectionResponse implements IJsonBackedObject {

    /**
     * The list of MobileLobApp within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<MobileLobApp> value;
