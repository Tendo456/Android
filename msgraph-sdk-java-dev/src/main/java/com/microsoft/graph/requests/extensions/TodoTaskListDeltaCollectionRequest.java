...
public class TodoTaskListDeltaCollectionRequest extends BaseCollectionRequest<TodoTaskListDeltaCollectionResponse, ITodoTaskListDeltaCollectionPage> implements ITodoTaskListDeltaCollectionRequest {
     ...
     */
    public TodoTaskListDeltaCollectionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
    ...
    public ITodoTaskListDeltaCollectionPage buildFromResponse(final TodoTaskListDeltaCollectionResponse response) {
        final ITodoTaskListDeltaCollectionRequestBuilder builder;
        if (response.nextLink != null) {
            builder = new TodoTaskListDeltaCollectionRequestBuilder(response.nextLink, getBaseRequest().getClient(), /* options */ null);
        } else {
            builder = null;
        }
        final ITodoTaskListDeltaCollectionPage page = new TodoTaskListDeltaCollectionPage(response, builder);
     ...
     */
    public ITodoTaskListDeltaCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public ITodoTaskListDeltaCollectionRequest top(final int value) {
     ...
     * @return the updated request
     */
    public ITodoTaskListDeltaCollectionRequest expand(final String value) {
