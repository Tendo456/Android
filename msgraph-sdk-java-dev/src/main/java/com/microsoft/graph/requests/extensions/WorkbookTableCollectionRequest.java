...
public class WorkbookTableCollectionRequest extends BaseCollectionRequest<WorkbookTableCollectionResponse, IWorkbookTableCollectionPage> implements IWorkbookTableCollectionRequest {
    ...
    public void get(final ICallback<? super IWorkbookTableCollectionPage> callback) {
     ...
     * @return the updated request
     */
    public IWorkbookTableCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookTableCollectionRequest skip(final int value) {
     ...
     * @return the updated request
     */
    public IWorkbookTableCollectionRequest skipToken(final String skipToken) {
    	addQueryOption(new QueryOption("$skiptoken", skipToken));
        return (IWorkbookTableCollectionRequest)this;
    }
    public IWorkbookTableCollectionPage buildFromResponse(final WorkbookTableCollectionResponse response) {
