...
public class Windows81GeneralConfigurationRequestBuilder extends BaseRequestBuilder implements IWindows81GeneralConfigurationRequestBuilder {
     ...
     */
    public IWindows81GeneralConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
    ...
    public IWindows81GeneralConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.Windows81GeneralConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
