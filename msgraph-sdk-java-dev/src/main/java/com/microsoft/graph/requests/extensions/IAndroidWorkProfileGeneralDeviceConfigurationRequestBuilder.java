...
/**
 * The interface for the Android Work Profile General Device Configuration Request Builder.
 */
public interface IAndroidWorkProfileGeneralDeviceConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     * @return the IAndroidWorkProfileGeneralDeviceConfigurationRequest instance
     */
    IAndroidWorkProfileGeneralDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
