...
/**
 * The interface for the Ios Custom Configuration Request.
 */
public interface IIosCustomConfigurationRequest extends IHttpRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    void put(final IosCustomConfiguration newIosCustomConfiguration, final ICallback<? super IosCustomConfiguration> callback);
     ...
     */
    IIosCustomConfigurationRequest select(final String value);
     ...
     * @return the updated request
     */
    IIosCustomConfigurationRequest expand(final String value);
