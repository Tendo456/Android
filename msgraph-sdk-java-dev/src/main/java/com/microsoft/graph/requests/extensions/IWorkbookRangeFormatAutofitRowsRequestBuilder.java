 ...
 */
public interface IWorkbookRangeFormatAutofitRowsRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookRangeFormatAutofitRowsRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
