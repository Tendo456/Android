...
/**
 * The interface for the Windows Defender Advanced Threat Protection Configuration Request Builder.
 */
public interface IWindowsDefenderAdvancedThreatProtectionConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IWindowsDefenderAdvancedThreatProtectionConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
