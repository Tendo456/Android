 ...
 */
public class Win32LobAppRequestBuilder extends BaseRequestBuilder implements IWin32LobAppRequestBuilder {
     ...
     * @return the IWin32LobAppRequest instance
     */
    public IWin32LobAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
