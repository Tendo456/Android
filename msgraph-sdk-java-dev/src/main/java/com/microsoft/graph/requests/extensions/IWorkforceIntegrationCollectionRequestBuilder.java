...
/**
 * The interface for the Workforce Integration Collection Request Builder.
 */
public interface IWorkforceIntegrationCollectionRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkforceIntegrationCollectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IUserRequest instance
     */
    IWorkforceIntegrationCollectionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);

    IWorkforceIntegrationRequestBuilder byId(final String id);
