...
/**
 * The interface for the Claims Mapping Policy Collection Page.
 */
public interface IClaimsMappingPolicyCollectionPage extends IBaseCollectionPage<ClaimsMappingPolicy, IClaimsMappingPolicyCollectionRequestBuilder> {
}
