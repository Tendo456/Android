 ...
 */
public class WorkbookFunctionsMatchRequest extends BaseRequest implements IWorkbookFunctionsMatchRequest {
     ...
     */
    public WorkbookFunctionsMatchRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
