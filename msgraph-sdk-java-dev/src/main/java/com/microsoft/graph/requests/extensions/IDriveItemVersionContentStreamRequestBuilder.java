...
public interface IDriveItemVersionContentStreamRequestBuilder extends IRequestBuilder {
     ...
     */
    IDriveItemVersionContentStreamRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IDriveItemVersionContentStreamRequest instance
     */
    IDriveItemVersionContentStreamRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
