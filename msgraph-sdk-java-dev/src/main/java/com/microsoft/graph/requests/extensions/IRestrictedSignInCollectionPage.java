...
/**
 * The interface for the Restricted Sign In Collection Page.
 */
public interface IRestrictedSignInCollectionPage extends IBaseCollectionPage<RestrictedSignIn, IRestrictedSignInCollectionRequestBuilder> {
}
