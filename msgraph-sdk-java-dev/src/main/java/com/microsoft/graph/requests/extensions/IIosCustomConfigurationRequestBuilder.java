...
/**
 * The interface for the Ios Custom Configuration Request Builder.
 */
public interface IIosCustomConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IIosCustomConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
