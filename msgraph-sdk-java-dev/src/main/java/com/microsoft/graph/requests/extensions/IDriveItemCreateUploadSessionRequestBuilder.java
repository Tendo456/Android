 ...
 */
public interface IDriveItemCreateUploadSessionRequestBuilder extends IRequestBuilder {
     ...
     */
    IDriveItemCreateUploadSessionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
