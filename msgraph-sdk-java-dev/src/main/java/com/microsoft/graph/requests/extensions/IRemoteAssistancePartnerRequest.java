...
/**
 * The interface for the Remote Assistance Partner Request.
 */
public interface IRemoteAssistancePartnerRequest extends IHttpRequest {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    RemoteAssistancePartner put(final RemoteAssistancePartner newRemoteAssistancePartner) throws ClientException;
     ...
     */
    IRemoteAssistancePartnerRequest select(final String value);
     ...
     * @return the updated request
     */
    IRemoteAssistancePartnerRequest expand(final String value);
