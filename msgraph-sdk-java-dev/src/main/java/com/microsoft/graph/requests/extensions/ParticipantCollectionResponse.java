...
/**
 * The class for the Participant Collection Response.
 */
public class ParticipantCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Participant within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Participant> value;
