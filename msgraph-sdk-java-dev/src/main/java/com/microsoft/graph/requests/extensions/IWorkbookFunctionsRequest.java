...
public interface IWorkbookFunctionsRequest extends IHttpRequest {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    WorkbookFunctions put(final WorkbookFunctions newWorkbookFunctions) throws ClientException;
     ...
     */
    IWorkbookFunctionsRequest select(final String value);
     ...
     * @return the updated request
     */
    IWorkbookFunctionsRequest expand(final String value);
