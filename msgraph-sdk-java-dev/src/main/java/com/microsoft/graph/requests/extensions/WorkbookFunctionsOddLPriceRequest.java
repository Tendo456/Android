...
public class WorkbookFunctionsOddLPriceRequest extends BaseRequest implements IWorkbookFunctionsOddLPriceRequest {
     ...
     */
    public WorkbookFunctionsOddLPriceRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
