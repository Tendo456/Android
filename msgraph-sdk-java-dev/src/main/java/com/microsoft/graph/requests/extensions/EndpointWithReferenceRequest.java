...
public class EndpointWithReferenceRequest extends BaseRequest implements IEndpointWithReferenceRequest {
     ...
     */
    public EndpointWithReferenceRequest(String requestUrl, IBaseClient client, java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        super(requestUrl, client, requestOptions, Endpoint.class);
    }

    public void post(final Endpoint newEndpoint, final IJsonBackedObject payload, final ICallback<? super Endpoint> callback) {
        send(HttpMethod.POST, callback, payload);
    }

    public Endpoint post(final Endpoint newEndpoint, final IJsonBackedObject payload) throws ClientException {
     ...
     */
    public IEndpointWithReferenceRequest select(final String value) {
        getQueryOptions().add(new com.microsoft.graph.options.QueryOption("$select", value));
        return (IEndpointWithReferenceRequest)this;
    }
     ...
     * @return the updated request
     */
    public IEndpointWithReferenceRequest expand(final String value) {
