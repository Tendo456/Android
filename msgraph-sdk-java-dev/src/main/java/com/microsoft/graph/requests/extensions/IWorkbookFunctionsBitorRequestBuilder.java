 ...
 */
public interface IWorkbookFunctionsBitorRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsBitorRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
