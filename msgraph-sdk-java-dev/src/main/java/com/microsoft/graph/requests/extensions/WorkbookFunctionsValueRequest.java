 ...
 */
public class WorkbookFunctionsValueRequest extends BaseRequest implements IWorkbookFunctionsValueRequest {
     ...
     */
    public WorkbookFunctionsValueRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
