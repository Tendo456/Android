...
/**
 * The interface for the Search Entity Query Collection Page.
 */
public interface ISearchEntityQueryCollectionPage extends IBaseCollectionPage<SearchResponse, ISearchEntityQueryCollectionRequestBuilder> {
}
