 ...
 */
public interface IWorkbookFunctionsMdurationRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsMdurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
