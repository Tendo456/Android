...
/**
 * The interface for the Site Collection With References Request Builder.
 */
public interface ISiteCollectionWithReferencesRequestBuilder extends IRequestBuilder {
    ...
    ISiteWithReferenceRequestBuilder byId(final String id);

    ISiteCollectionReferenceRequestBuilder references();
}
