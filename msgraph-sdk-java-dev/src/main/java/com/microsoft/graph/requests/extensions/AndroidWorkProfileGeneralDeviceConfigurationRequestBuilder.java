 ...
 */
public class AndroidWorkProfileGeneralDeviceConfigurationRequestBuilder extends BaseRequestBuilder implements IAndroidWorkProfileGeneralDeviceConfigurationRequestBuilder {
     ...
     */
    public AndroidWorkProfileGeneralDeviceConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidWorkProfileGeneralDeviceConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidWorkProfileGeneralDeviceConfigurationRequest instance
     */
    public IAndroidWorkProfileGeneralDeviceConfigurationRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidWorkProfileGeneralDeviceConfigurationRequest(getRequestUrl(), getClient(), requestOptions);
    }
