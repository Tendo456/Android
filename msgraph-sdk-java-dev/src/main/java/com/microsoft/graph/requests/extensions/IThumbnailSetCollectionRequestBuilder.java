 ...
 */
public interface IThumbnailSetCollectionRequestBuilder extends IRequestBuilder {
     ...
     */
    IThumbnailSetCollectionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IUserRequest instance
     */
    IThumbnailSetCollectionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
