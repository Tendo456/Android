...
public interface IWorkbookChartAxesRequest extends IHttpRequest {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    WorkbookChartAxes put(final WorkbookChartAxes newWorkbookChartAxes) throws ClientException;
     ...
     */
    IWorkbookChartAxesRequest select(final String value);
     ...
     * @return the updated request
     */
    IWorkbookChartAxesRequest expand(final String value);
