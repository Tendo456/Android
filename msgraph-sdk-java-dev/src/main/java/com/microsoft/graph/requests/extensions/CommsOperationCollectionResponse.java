 ...
 */
public class CommsOperationCollectionResponse implements IJsonBackedObject {

    /**
     * The list of CommsOperation within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<CommsOperation> value;
