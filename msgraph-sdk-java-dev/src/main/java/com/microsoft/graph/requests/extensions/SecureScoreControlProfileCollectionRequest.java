...
public class SecureScoreControlProfileCollectionRequest extends BaseCollectionRequest<SecureScoreControlProfileCollectionResponse, ISecureScoreControlProfileCollectionPage> implements ISecureScoreControlProfileCollectionRequest {
    ...
    public void get(final ICallback<? super ISecureScoreControlProfileCollectionPage> callback) {
     ...
     */
    public ISecureScoreControlProfileCollectionRequest expand(final String value) {
     ...
     * @return the updated request
     */
    public ISecureScoreControlProfileCollectionRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public ISecureScoreControlProfileCollectionRequest orderBy(final String value) {
     ...
     * @return the updated request
     */
    public ISecureScoreControlProfileCollectionRequest select(final String value) {
     ...
     * @return the updated request
     */
    public ISecureScoreControlProfileCollectionRequest top(final int value) {
