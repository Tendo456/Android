...
/**
 * The interface for the Open Shift Change Request Request.
 */
public interface IOpenShiftChangeRequestRequest extends IHttpRequest {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    OpenShiftChangeRequest put(final OpenShiftChangeRequest newOpenShiftChangeRequest) throws ClientException;
     ...
     */
    IOpenShiftChangeRequestRequest select(final String value);
     ...
     * @return the updated request
     */
    IOpenShiftChangeRequestRequest expand(final String value);
