...
public class IosCertificateProfileRequestBuilder extends BaseRequestBuilder implements IIosCertificateProfileRequestBuilder {
     ...
     */
    public IIosCertificateProfileRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
    ...
    public IIosCertificateProfileRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.IosCertificateProfileRequest(getRequestUrl(), getClient(), requestOptions);
    }
