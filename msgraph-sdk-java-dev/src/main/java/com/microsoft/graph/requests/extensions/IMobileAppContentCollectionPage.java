...
/**
 * The interface for the Mobile App Content Collection Page.
 */
public interface IMobileAppContentCollectionPage extends IBaseCollectionPage<MobileAppContent, IMobileAppContentCollectionRequestBuilder> {
}
