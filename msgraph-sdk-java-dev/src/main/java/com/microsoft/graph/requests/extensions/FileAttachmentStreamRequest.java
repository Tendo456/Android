...
public class FileAttachmentStreamRequest extends BaseStreamRequest<FileAttachment> implements IFileAttachmentStreamRequest {
     ...
     */
    public FileAttachmentStreamRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @throws ClientException an exception occurs if there was an error while the request was sent
     */
    public FileAttachment put(final byte[] fileContents) throws ClientException {
