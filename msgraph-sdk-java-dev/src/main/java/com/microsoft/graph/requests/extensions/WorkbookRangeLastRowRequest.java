 ...
 */
public class WorkbookRangeLastRowRequest extends BaseRequest implements IWorkbookRangeLastRowRequest {
     ...
     */
    public WorkbookRangeLastRowRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
