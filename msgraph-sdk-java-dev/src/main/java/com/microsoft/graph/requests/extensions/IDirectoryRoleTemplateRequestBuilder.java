 ...
 */
public interface IDirectoryRoleTemplateRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IDirectoryRoleTemplateRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
