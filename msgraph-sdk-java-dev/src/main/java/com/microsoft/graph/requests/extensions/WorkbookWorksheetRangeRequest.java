 ...
 */
public class WorkbookWorksheetRangeRequest extends BaseRequest implements IWorkbookWorksheetRangeRequest {
     ...
     */
    public WorkbookWorksheetRangeRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the updated request
     */
    public IWorkbookWorksheetRangeRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IWorkbookWorksheetRangeRequest orderBy(final String value) {
