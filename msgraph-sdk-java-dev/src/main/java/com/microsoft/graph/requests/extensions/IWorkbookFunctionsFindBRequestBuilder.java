 ...
 */
public interface IWorkbookFunctionsFindBRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsFindBRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
