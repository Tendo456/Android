...
public interface IOpenTypeExtensionRequestBuilder extends IRequestBuilder {
     ...
     */
    IOpenTypeExtensionRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IOpenTypeExtensionRequest instance
     */
    IOpenTypeExtensionRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
