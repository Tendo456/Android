...
/**
 * The interface for the Localized Notification Message Request Builder.
 */
public interface ILocalizedNotificationMessageRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    ILocalizedNotificationMessageRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
