 ...
 */
public interface IWorkbookFunctionsDdbRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsDdbRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
