...
public interface IGroupUnsubscribeByMailRequestBuilder extends IRequestBuilder {
     ...
     */
    IGroupUnsubscribeByMailRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IGroupUnsubscribeByMailRequest instance
     */
    IGroupUnsubscribeByMailRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
