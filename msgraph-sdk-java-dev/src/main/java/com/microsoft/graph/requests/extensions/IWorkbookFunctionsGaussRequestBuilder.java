 ...
 */
public interface IWorkbookFunctionsGaussRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookFunctionsGaussRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
