...
/**
 * The class for the Android Work Profile Compliance Policy Request Builder.
 */
public class AndroidWorkProfileCompliancePolicyRequestBuilder extends BaseRequestBuilder implements IAndroidWorkProfileCompliancePolicyRequestBuilder {
     ...
     */
    public AndroidWorkProfileCompliancePolicyRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     */
    public IAndroidWorkProfileCompliancePolicyRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IAndroidWorkProfileCompliancePolicyRequest instance
     */
    public IAndroidWorkProfileCompliancePolicyRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.requests.extensions.AndroidWorkProfileCompliancePolicyRequest(getRequestUrl(), getClient(), requestOptions);
    }
