 ...
 */
public interface IPlannerGroupRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IPlannerGroupRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IPlannerGroupRequest instance
     */
    IPlannerGroupRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
