 ...
 */
public class ServicePrincipalRemovePasswordRequest extends BaseRequest implements IServicePrincipalRemovePasswordRequest {
     ...
     */
    public IServicePrincipalRemovePasswordRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IServicePrincipalRemovePasswordRequest top(final int value) {
