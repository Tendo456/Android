...
/**
 * The interface for the Time Off Request Request Builder.
 */
public interface ITimeOffRequestRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    ITimeOffRequestRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
