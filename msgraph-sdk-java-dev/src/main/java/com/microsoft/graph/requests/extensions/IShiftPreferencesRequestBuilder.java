...
/**
 * The interface for the Shift Preferences Request Builder.
 */
public interface IShiftPreferencesRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IShiftPreferencesRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
