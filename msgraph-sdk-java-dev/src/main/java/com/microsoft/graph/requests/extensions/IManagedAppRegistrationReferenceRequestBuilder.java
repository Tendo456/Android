...
/**
 * The interface for the Managed App Registration Reference Request Builder.
 */
public interface IManagedAppRegistrationReferenceRequestBuilder extends IRequestBuilder {
