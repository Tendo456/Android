...
/**
 * The interface for the Managed IOSStore App Request Builder.
 */
public interface IManagedIOSStoreAppRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IManagedIOSStoreAppRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the IManagedIOSStoreAppRequest instance
     */
    IManagedIOSStoreAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
