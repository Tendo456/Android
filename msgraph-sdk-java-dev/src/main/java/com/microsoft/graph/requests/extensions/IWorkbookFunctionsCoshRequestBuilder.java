 ...
 */
public interface IWorkbookFunctionsCoshRequestBuilder extends IRequestBuilder {
     ...
     * @return the IWorkbookFunctionsCoshRequest instance
     */
    IWorkbookFunctionsCoshRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
}
