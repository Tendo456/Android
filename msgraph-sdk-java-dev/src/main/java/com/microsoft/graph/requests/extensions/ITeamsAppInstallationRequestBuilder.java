...
/**
 * The interface for the Teams App Installation Request Builder.
 */
public interface ITeamsAppInstallationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    ITeamsAppInstallationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
