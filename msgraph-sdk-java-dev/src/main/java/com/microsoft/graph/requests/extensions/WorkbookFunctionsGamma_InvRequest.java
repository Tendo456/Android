...
public class WorkbookFunctionsGamma_InvRequest extends BaseRequest implements IWorkbookFunctionsGamma_InvRequest {
     ...
     */
    public WorkbookFunctionsGamma_InvRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
