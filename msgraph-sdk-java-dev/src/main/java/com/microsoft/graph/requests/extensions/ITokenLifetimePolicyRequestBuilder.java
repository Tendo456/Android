...
/**
 * The interface for the Token Lifetime Policy Request Builder.
 */
public interface ITokenLifetimePolicyRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    ITokenLifetimePolicyRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
