...
/**
 * The interface for the Report Root Device Configuration User Activity Request.
 */
public interface IReportRootDeviceConfigurationUserActivityRequest extends IHttpRequest {
