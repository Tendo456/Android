 ...
 */
public interface ISubscribedSkuRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    ISubscribedSkuRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
