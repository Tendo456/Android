...
/**
 * The interface for the Online Meeting Request Builder.
 */
public interface IOnlineMeetingRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IOnlineMeetingRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
