...
/**
 * The interface for the Play Prompt Operation Request Builder.
 */
public interface IPlayPromptOperationRequestBuilder extends IRequestBuilder {
     ...
     */
    IPlayPromptOperationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
