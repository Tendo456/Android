...
public interface ITeamsAppRequestBuilder extends IRequestBuilder {
     ...
     */
    ITeamsAppRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
     ...
     * @return the ITeamsAppRequest instance
     */
    ITeamsAppRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions);
