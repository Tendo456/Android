...
/**
 * The interface for the Secure Score Request Builder.
 */
public interface ISecureScoreRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    ISecureScoreRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
