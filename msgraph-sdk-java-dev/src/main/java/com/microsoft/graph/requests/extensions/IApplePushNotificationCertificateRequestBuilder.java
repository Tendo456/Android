...
/**
 * The interface for the Apple Push Notification Certificate Request Builder.
 */
public interface IApplePushNotificationCertificateRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IApplePushNotificationCertificateRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
