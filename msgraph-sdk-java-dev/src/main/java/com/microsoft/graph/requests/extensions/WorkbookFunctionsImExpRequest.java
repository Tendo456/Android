...
public class WorkbookFunctionsImExpRequest extends BaseRequest implements IWorkbookFunctionsImExpRequest {
     ...
     */
    public WorkbookFunctionsImExpRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
