...
/**
 * The interface for the Aad User Conversation Member Request Builder.
 */
public interface IAadUserConversationMemberRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IAadUserConversationMemberRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
