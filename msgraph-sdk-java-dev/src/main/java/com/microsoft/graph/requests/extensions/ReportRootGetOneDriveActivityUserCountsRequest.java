 ...
 */
public class ReportRootGetOneDriveActivityUserCountsRequest extends BaseRequest implements IReportRootGetOneDriveActivityUserCountsRequest {
     ...
     */
    public ReportRootGetOneDriveActivityUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     * @return the updated request
     */
    public IReportRootGetOneDriveActivityUserCountsRequest filter(final String value) {
     ...
     * @return the updated request
     */
    public IReportRootGetOneDriveActivityUserCountsRequest orderBy(final String value) {
