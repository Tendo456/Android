...
/**
 * The interface for the Directory Role Delta Collection Page.
 */
public interface IDirectoryRoleDeltaCollectionPage extends IBaseCollectionPage<DirectoryRole, IDirectoryRoleDeltaCollectionRequestBuilder> {
    /**
