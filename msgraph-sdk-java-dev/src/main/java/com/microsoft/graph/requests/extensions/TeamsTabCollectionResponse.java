 ...
 */
public class TeamsTabCollectionResponse implements IJsonBackedObject {

    /**
     * The list of TeamsTab within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<TeamsTab> value;
