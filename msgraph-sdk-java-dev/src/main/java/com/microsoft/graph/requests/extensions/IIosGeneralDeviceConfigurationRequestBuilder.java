...
/**
 * The interface for the Ios General Device Configuration Request Builder.
 */
public interface IIosGeneralDeviceConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IIosGeneralDeviceConfigurationRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
