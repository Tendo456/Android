...
/**
 * The interface for the Permission Grant Condition Set Collection Request.
 */
public interface IPermissionGrantConditionSetCollectionRequest extends IHttpRequest {
     ...
     */
    IPermissionGrantConditionSetCollectionRequest expand(final String value);
     ...
     * @return the updated request
     */
    IPermissionGrantConditionSetCollectionRequest filter(final String value);
     ...
     * @return the updated request
     */
    IPermissionGrantConditionSetCollectionRequest orderBy(final String value);
     ...
     * @return the updated request
     */
    IPermissionGrantConditionSetCollectionRequest select(final String value);
     ...
     * @return the updated request
     */
    IPermissionGrantConditionSetCollectionRequest top(final int value);
     ...
     * @return the updated request
     */
    IPermissionGrantConditionSetCollectionRequest skip(final int value);
