 ...
 */
public class WorkbookFunctionsWeibull_DistRequest extends BaseRequest implements IWorkbookFunctionsWeibull_DistRequest {
     ...
     */
    public WorkbookFunctionsWeibull_DistRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
