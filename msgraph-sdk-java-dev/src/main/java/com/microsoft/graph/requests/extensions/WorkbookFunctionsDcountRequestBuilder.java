 ...
 */
public class WorkbookFunctionsDcountRequestBuilder extends BaseActionRequestBuilder implements IWorkbookFunctionsDcountRequestBuilder {
     ...
     */
    public IWorkbookFunctionsDcountRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions) {
     ...
     * @return the IWorkbookFunctionsDcountRequest instance
     */
    public IWorkbookFunctionsDcountRequest buildRequest(final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
