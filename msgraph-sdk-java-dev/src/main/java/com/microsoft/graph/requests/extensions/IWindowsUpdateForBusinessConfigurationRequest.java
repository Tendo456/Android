...
/**
 * The interface for the Windows Update For Business Configuration Request.
 */
public interface IWindowsUpdateForBusinessConfigurationRequest extends IHttpRequest {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    WindowsUpdateForBusinessConfiguration put(final WindowsUpdateForBusinessConfiguration newWindowsUpdateForBusinessConfiguration) throws ClientException;
     ...
     */
    IWindowsUpdateForBusinessConfigurationRequest select(final String value);
     ...
     * @return the updated request
     */
    IWindowsUpdateForBusinessConfigurationRequest expand(final String value);
