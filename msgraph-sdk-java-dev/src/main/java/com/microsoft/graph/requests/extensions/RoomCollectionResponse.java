...
/**
 * The class for the Room Collection Response.
 */
public class RoomCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Room within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<Room> value;
