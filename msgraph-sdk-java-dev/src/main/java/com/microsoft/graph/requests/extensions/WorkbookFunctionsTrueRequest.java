 ...
 */
public class WorkbookFunctionsTrueRequest extends BaseRequest implements IWorkbookFunctionsTrueRequest {
     ...
     */
    public WorkbookFunctionsTrueRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
