 ...
 */
public interface IOutlookItemRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
     ...
     */
    IOutlookItemRequest buildRequest(final com.microsoft.graph.options.Option... requestOptions);
