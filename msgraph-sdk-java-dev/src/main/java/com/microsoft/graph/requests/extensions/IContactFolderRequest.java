...
public interface IContactFolderRequest extends IHttpRequest {
     ...
     * @throws ClientException this exception occurs if the request was unable to complete for any reason
     */
    ContactFolder put(final ContactFolder newContactFolder) throws ClientException;
     ...
     */
    IContactFolderRequest select(final String value);
     ...
     * @return the updated request
     */
    IContactFolderRequest expand(final String value);
