 ...
 */
public class CallRecordCollectionResponse implements IJsonBackedObject {

    /**
     * The list of CallRecord within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<CallRecord> value;
