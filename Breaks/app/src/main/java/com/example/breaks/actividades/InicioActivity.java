...
public class InicioActivity extends AppCompatActivity {
    ...
    private void  sesion(){
        ...
        mAuthListener = firebaseAuth -> {
            ...
            if (user != null) {
                ...
                Toast.makeText(InicioActivity.this, "Bienvenido "+user.getDisplayName(), Toast.LENGTH_SHORT).show();
    ...
    public void cerrarsesion (){
        ...
        AuthUI.getInstance().signOut(this).addOnCompleteListener(task -> Toast.makeText(InicioActivity.this,"Sesion Cerrada", Toast.LENGTH_SHORT).show());
        finish();
    }
