...
public class MarcasAdapter extends RecyclerView.Adapter<MarcasAdapter.MarcasAdapterVH> {
    ...
    @NonNull
    @Override
    public MarcasAdapter.MarcasAdapterVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        contextM = parent.getContext();
        return new MarcasAdapter.MarcasAdapterVH(LayoutInflater.from(contextM).inflate(R.layout.row_users,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull MarcasAdapter.MarcasAdapterVH holder, int position) {
